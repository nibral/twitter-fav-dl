...
module.exports.downloadFavTweetsAndParseImageURLs = (client, screenName) => {
    return new Promise((resolve, reject) => {
        co(function* () {
            const userInfo = yield module.exports.getUserInfo(client, screenName);
            const numOfLike = userInfo.favourites_count;
            ...
            for (let ri = 0; ri < numOfRequest; ri++) {
                const pTweets = yield module.exports.downloadPartOfFavTweets(client, screenName, maxID);
